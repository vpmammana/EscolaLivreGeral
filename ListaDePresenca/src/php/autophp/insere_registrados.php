...
<tr class='cabecalio_table'><th></th><th>id</th><th>nome_registrado</th></tr>";
...
for (i=0; i<pontos.length; i++){
	...
	carrega_NtoN(pontos[i].id,'escolax', 'registrados','id_documento',document.getElementById(pontos[i].id).innerText);
...
var resposta='';
var url='apaga_registro.php?banco=escolax&tabela=registrados&id='+id;
alert(url);
var oReq=new XMLHttpRequest();
oReq.open('GET', url, false);
oReq.onload= function (e) {
