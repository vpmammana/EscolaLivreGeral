...
var total_barras=document.getElementsByClassName("barras").length; // eh a mesma definicao para numdiv. Reproduzi aqui para nao atrapalhar o algoritmo principal (teria que puxar de lah e isso exigiria mais custos com testes 
		...
		if (velho_evidente>0) {
				...
				document.getElementById(velho_evidente).style.backgroundColor="silver";
				document.getElementById(velho_evidente).style.color="black";
		}

		document.getElementById(evidente).style.color="white";
		document.getElementById(evidente).style.backgroundColor="darkblue";
...
table {vertical-align: top; color: inherit; padding: 5px;height: auto}
td {vertical-align: top; color: inherit; border-right: 1px solid green; height: 2rem;}
...
#conteudo {  /* eh o div que contem a palheta */
top: 0px;
height: 100%;
width: 35%;
left: 65%;
...
<span id='titulo_search_box'><b>Janela de Busca:</b></span>
